...
function createState(tutorial: ProviderTutorial): UseProviderCardStateResult {
  return {
    ...
    lmStudioModels: [],
    lmStudioStatus: 'idle',
    lmStudioMessage: null,
    lmStudioBusyKey: null,
    lmStudioRuntime: null,
    refreshLmStudioModels: () => Promise.resolve(),
    handleLoadLmStudioModel: () => Promise.resolve(),
    handleUnloadLmStudioModel: () => Promise.resolve(),
    isLmStudioModelEnabled: () => false,
    isLmStudioModelDefault: () => false,
    handleUseLmStudioForAnalysis: () => Promise.resolve(),
    handleEnableLocalBridge: () => Promise.resolve(),
