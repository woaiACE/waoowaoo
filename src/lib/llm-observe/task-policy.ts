...
const POLICY_BY_TASK_TYPE: Partial<Record<TaskType, LLMTaskPolicy>> = {
  ...
  // LXT 剧本模式
  [TASK_TYPE.LXT_NOVEL_TO_SCRIPT]: LLM_STANDARD_POLICY,
  [TASK_TYPE.LXT_SCRIPT_TO_STORYBOARD]: LLM_STANDARD_POLICY,
  [TASK_TYPE.LXT_STORYBOARD_TO_SCRIPT]: LLM_STANDARD_POLICY,
}
