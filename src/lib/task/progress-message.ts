...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.DIRECTOR_MODE_RUN]: 'progress.taskType.directorModeRun',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  director_mode_prepare: 'progress.stage.directorModePrepare',
  director_mode_step: 'progress.stage.directorModeStep',
