...
const IMAGE_TYPES = new Set<TaskType>([
  ...
  // IP 模式
  TASK_TYPE.IP_IMAGE_PANEL,
  TASK_TYPE.IP_IMAGE_CHARACTER,
  TASK_TYPE.IP_REF_SHEET_GENERATE,
  TASK_TYPE.IP_VARIANT_PREVIEW,
  // LXT 剧本模式
  TASK_TYPE.LXT_ASSET_IMAGE,
  TASK_TYPE.LXT_FINAL_FILM_IMAGE,
])
